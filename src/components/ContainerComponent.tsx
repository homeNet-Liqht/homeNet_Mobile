...
const ContainerComponent = (props: Props) => {
  ...
  const headerComponent = () => {
    return (
      <View
        style={[{ flex: 1, paddingTop: appInfo.size.HEIGHT * 0.025 }, Style]}
      >
        {(title || back) && (
          <RowComponent
            styles={{
          ...
          >
            {back && (
              ...
              >
                <ArrowLeft
                  size={24}
                  color={arrowStyle ? arrowStyle : appColors.text}
                />
              </TouchableOpacity>
            )}
            {title ? (
  ...
  return isImageBackground ? (
    ...
    >
      ...
      {moreAction && (
        <CustomBottomSheet
          titleBottomSheet={moreAction.titleBottomSheet}
          navigation={navigation}
          ref={bottomSheetModalRef}
          dataBottomSheet={moreAction.dataBottomSheet}
        />
      )}
    </ImageBackground>
  ) : (
